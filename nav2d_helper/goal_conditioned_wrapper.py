...
class GoalConditionedPointWrapper(gym.Wrapper):
    ...
    def _normalize_obs(self, obs):
        ...
        """Normalize observation to be in [0, 1]."""
    ...
    def reset(self):
        ...
        """Reset the environment. Return initial state and goal."""
    ...
    def step(self, action):
        ...
        """Step the environment. Return observation, 
        reward, done, info and goal."""
    ...
    def max_goal_dist(self):
        """Returns the maximum possible distance between any two states."""
        apsp = self.env._apsp
